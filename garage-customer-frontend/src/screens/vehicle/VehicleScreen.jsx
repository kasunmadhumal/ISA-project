...
import { uploadToFirebase , ownerVehiclesList, submitCustomerVehicleDetails, onDeleteVehicleFromAccount} from './VehicleScreenService';
...
const VehicleScreen = () => {
    ...
    const [vehicleDetailsLoadingWaiting, setVehicleDetailsLoadingWaiting] = useState(false);
    ...
    const normFile = (info) => {
      ...
      const onDeleteVehicle = (vehicleNumber) => {
        ...
        onDeleteVehicleFromAccount(vehicleNumber, ownerEmail, setVehicleList, setVehicleDetailsLoadingWaiting);
        }
      ...
      const handleSubmit = async (values) => {  
        ...
        try {
            setWaiting(true);
            await submitCustomerVehicleDetails(values, ownerEmail, imageUrl, setVehicleList, setVehicleDetailsLoadingWaiting);
            setWaiting(false);
          } catch (error) {
            setWaiting(false);
        ...
        <div className='vehicle-page-container'>
            ...
            <div className='vehicle-content-container'>
                ...
                >
                    ...
                    rules={[
                        ...
                        validator: async (_, value) => {
                            ...
                            return Promise.reject(new Error('Please input a valid year!'));
                        },
                    ...
                    <Form.Item label="Vehicle Type" name="vehicleType" className='vehicle-details-input' >
                    <Select>
                        <Select.Option value="sedan">SEDAN</Select.Option>
                        <Select.Option value="station wagon">STATION WAGON</Select.Option>
                    ...
                    <Form.Item
                        ...
                        rules={[
                            ...
                            validator: async (_, value) => {
                                ...
                                return Promise.reject(new Error('Please input a valid seat count!'));
                            },
                    ...
                    <Form.Item
                        ...
                        rules={[
                            ...
                            validator: async (_, value) => {
                                ...
                                return Promise.reject(new Error('Please input a valid door count!'));
                            },
                    ...
                    <Form.Item
                        ...
                        rules={[
                            ...
                            validator: async (_, value) => {
                                ...
                                return Promise.reject(new Error('Please input a valid distance limit!'));
                            },
               ...
               <div className='vehicle-view-container'>
                    ...
                    <div className='vehicle-view-content' style={{ height: '955px', overflowY: 'auto'}}>
                        {
                           ...
                           vehicleList && vehicleList.map((vehicle, index) => {
                                return (
                                        <div key={index} className='vehicle-view-card'>
                                            <VehicleComponent vehicle={vehicle} onDeleteVehicle={onDeleteVehicle} from={"vehicle-management"} onEditVehicle={onEditVehicle} />
                                        </div>
